...
/// @title ERC721Metadata NFT contract
/// @notice This contract can be used to mint and burn NFTs.
/// It implements the [ERC721](https://eips.ethereum.org/EIPS/eip-721) and [ERC721Metadata](https://eips.ethereum.org/EIPS/eip-721) interfaces.
...
interface IOkenV1NftPrivate {
    ...
    /// @notice Mints a new NFT to `to` with token URI `uri`.
    /// @dev The ETH amount sent must pay for the platform fee.
